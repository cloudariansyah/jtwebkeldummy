...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "",
		//email: "Kel.kalisari@gmail.com", // Email
...
s1.async=true;
s1.src='https://embed.tawk.to/6247f38c2abe5b455fc35cda/1fvkguo6p';
s1.charset='UTF-8';
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Kalisari</a>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/Bangunan Kantor.jpeg" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/Bangunan Kantor.jpeg" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/Bangunan Kantor.jpeg" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
                    <h4 class="font-weight-light">Kelurahan Kalisari</h4>
					<h1 class="font-weight-light">Kelurahan Kalisari</h1>
					<p>terletak di Jl. Kalisari RT 011/02 No.Raya, Kalisari, Kec. Ps. Rebo, Kota Jakarta Timur</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Kalisari<span class="text-muted">Kelurahan Kalisari</span></h2>
            <p class="lead">terletak di Jl. Kalisari RT 011/02 No.Raya, Kalisari, Kec. Ps. Rebo, Kota Jakarta Timur</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15861.710053964249!2d106.8412973184586!3d-6.338633599984901!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69edb328e4c2eb%3A0xd3d21ba8e0c83de4!2sKalisari%2C%20Pasar%20Rebo%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644469213904!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></iframe></p></div>
...
<li>Pizza Hut Restoran</li>
      ...
      <footer class="container">
        ...
        <p>&copy; <?=date('Y')?> Sudin Kominfotik JT &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
      </footer>
