...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Balekambang</title>
...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
                whatsapp: "021-8096875", // WhatsApp number
          instagram: "@kelurahanbalekambang",
		//email: "kelurahan.balekambang@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Balekambang</a>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/balekambang.JPG" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/balekambang.JPG" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/balekambang.JPG" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<h1 class="font-weight-light">Kelurahan Balekambang</h1>
					<p>terletak di JL. Gardu/Pucung RT. 009/02.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Balekambang <span class="text-muted">Kecamatan Kramat Jati</span></h2>
            <p class="lead">terletak di JL. Gardu/Pucung RT. 009/02.</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<li>TikTok: </li>
							<li>Twitter: </li>
							<li>Instagram: <a href="https://www.instagram.com/p/CWPJDqbhIr9">@kelurahanbalekambang</a> </li>
                <li>Facebook:<a href="https://www.facebook.com/kelurahan.balekambang"></a></li>
							<li>Youtube: </li>
							</ul>
                        </div>
                       <!-- <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">More Info</a></div>-->
