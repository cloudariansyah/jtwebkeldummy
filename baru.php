  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/Kelurahan Baru.jpg" alt="..." /></div>
                <div class="col-lg-5">
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">H. IDING</h1>
					...
					<h1 class="font-weight-light">Kelurahan Baru</h1>
					<p>terletak di Jl.Baru, Kec. Ps. Rebo, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Baru,+Pasar+Rebo,+East+Jakarta+City,+Jakarta/@-6.3232406,106.8383262,15z/data=!3m1!4b1!4m5!3m4!1s0x2e69edbea620c7cf:0xdac4fe1366cbe311!8m2!3d-6.3263594!4d106.8502879" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Rumah Sakit Umum Daerah Pasar Rebo</li>
<li>R.S Puskesmas Kelurahan Baru</li>
<li>Rumah Sakit Kesdam Jaya Cijantung</li>
<li>KLINIK BUNDA IKA MEDICA 1  48</li>
<li>Apotik BUNDA IKA MEDICA 1 II</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<li>Instagram: <a href="https://www.instagram.com/kelbaru.official/">@kelbaru.official</a> </li>
