...
<head>
  ...
  <title>Kelurahan Batu Ampar</title>
  ...
  <main id="main">
      ...
      <div class="container marketing">
		    ...
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Achmad Ruslan</h1>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Batu Ampar <span class="text-muted">Kecamatan Kramat Jati</span></h2>
            <p class="lead">terletak di Jl. Batu Ampar II No.8, RT.8/RW.3, Kramat Jati, Kec. Kramat jati, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13520, Indonesia.</p>
...
<li>Puskesmas Kel Batuampar</li>               
<li>Restoran Mekkah & Cafe - Makanan Tradisional Mekkah</li>
<li>Kuliner Makanan Bakso & Mie Ayam Pak Dono</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<li>Instagram: <a href="https://www.instagram.com/kel_batuampar_/">@kel_batuampar_</a> </li>
