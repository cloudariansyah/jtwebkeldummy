...
<head>
  ...
  <title>Kelurahan Cakung Barat</title>
  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_cakung_barat.jpg" alt="..." /></div>
                <div class="col-lg-5">
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Daniel Wisnu Parulian</h1>
					...
					<h1 class="font-weight-light">Kelurahan Cakung Barat</h1>
					<p>terletak di Jl. Tipar Cakung, Kelurahan Cakung Barat, Kecamatan Cakung, Kotamadya Jakarta Timur, Provinsi DKI Jakarta 13910-  Jakarta Timur luas wilayah 6,19 km2 dengan jumlah RW 9 jumlah RT 89.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Cakung Barat <span class="text-muted">Kecamatan Cakung</span></h2>
            <p class="lead">terletak di Jl. Tipar Cakung, Kelurahan Cakung Barat, Kecamatan Cakung, Kotamadya Jakarta Timur, Provinsi DKI Jakarta 13910-  Jakarta Timur luas wilayah 6,19 km2 dengan jumlah RW 9 jumlah RT 89.</p>
                    
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/West+Cakung,+Cakung,+East+Jakarta+City,+Jakarta/@-6.1723585,106.9151252,14z/data=!3m1!4b1!4m5!3m4!1s0x2e698adf79a29847:0xf65dd70d45710d07!8m2!3d-6.1754565!4d106.9329091" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<ul>
							<li>Pasar Cakung</li>
<li>Pasar Kalimalang Cakung</li>
<li>Puskesmas Cakung Barat</li>
<li>OLD Shanghai Sedayu City</li>
<li>MCDonald Sedayu City</li>
<li>Kuliner Makanan </li>
...
<li>Pizza Hut Restoran</li>
			    ...
			    <p class="card-text">No Telpon 021 4600915</p>
							<ul>
							 
							<li>Instagram: <a href="https://www.instagram.com/cakungtimurofficial/?hl=id">@cakungtimurofficial</a> </li>
