...
<head>
  ...
  <title>Kelurahan Cipinang Besar Utara</title>
  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_cipinang_besar_utara.jpg" alt="..." /></div>
                <div class="col-lg-5">
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Evi Erawati</h1>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Bambu+Apus,+Cipayung,+East+Jakarta+City,+Jakarta/@-6.313427,106.8867153,14z/data=!3m1!4b1!4m5!3m4!1s0x2e69ed491094c545:0xc9ea4b439d3a3dc2!8m2!3d-6.3092491!4d106.9033981" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Kantor Lurah Cipinang Besar Utara</li>
...
<li>Kost 88 Baru</li>
<li>SMKN 46 Jakarta</li>
<li>GOR Kurnia Badminton Court</li>
<li>Komplek LP Cipinang</li>
...
<li>Kedai Coffe</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi  (0622) 18505212</h2>
                            <p class="card-text">Jam operasional 07.00-16.00 WIB</p>
							<ul>
							 
							<li>Instagram: <a href="https://www.instagram.com/kel.cipinangbesarutara/?hl=id">@kel.cipinangbesarutara</a> </li>
