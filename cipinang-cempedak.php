...
<head>
  ...
  <title>Kelurahan Cipinang Cempedak</title>
        ...
        <ul>
          ...
          <li class="drop-down active"><a href="">Profil</a>
            <ul>
                ...
                <ul>
                  ...
                  <li><a href="#">Cagar Budaya Tak Benda</a></li>
                </ul>
              </li>
              <li><a href="#">Peta & Batas Wilayah</a></li>
          ...
          <li class="drop-down"><a href="">Layanan</a>
            <ul>
              ...
              <li><a href="#">Kanal Aduan</a></li>
              <li><a href="#">Kantor Perangkat Kota</a></li>
          ...
          <li class="drop-down"><a href="">Fasilitas</a>
            <ul>
              ...
              <li><a href="#">Pasar & UMKM</a></li>
              <li><a href="#">Perumahan</a></li>
              <li><a href="#">Internet Jakwifi</a></li>
  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_cipinang_cimpedak.jpg" alt="..." /></div>
                <div class="col-lg-5">
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Ika Yuli Rahayu</h1>
					...
					<h1 class="font-weight-light">Kelurahan Cipanang Cempedak</h1>
					<p>terletak di JL. Panti Asuhan, kelurahan Cipinang Cempedak, kecamatan Jatinegara, kotamadya Jakarta Timur, propinsi DKI Jakarta, 13340, Daerah Khusus Ibukota Jakarta luas wilayah 120 Ha dengan jumlah RW 11 jumlah RT 154 .</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Cipinang Cempedak<span class="text-muted">Kecamatan Jatinegara</span></h2>
            <p class="lead">terletak di JL. Panti Asuhan, kelurahan Cipinang Cempedak, kecamatan Jatinegara, kotamadya Jakarta Timur, propinsi DKI Jakarta, 13340, Daerah Khusus Ibukota Jakarta luas wilayah 120 Ha dengan jumlah RW 11 jumlah RT 154.</p>
                    
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Cipinang+Cempedak,+Jatinegara,+East+Jakarta+City,+Jakarta/@-6.2364021,106.8648802,15z/data=!3m1!4b1!4m5!3m4!1s0x2e69f30cd420b7a7:0xf3685407410d2862!8m2!3d-6.2386548!4d106.8738909" weight="100" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
...
<div class="row gx-4 gx-lg-5">
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Tupoksi</h2>
                            <p class="card-text">
...
<li>Pencatatan kelahiran penduduk WNI di wilayah RI</li>
<li>Pencatatan kematian WNI</li>
<li>Pencatatan kelahiran penduduk WNI yang tidak diketahui asal usulnya atau tidak diketahui keberadaan orang tuanya</li>
<li>Pencatatan kematian seseorang yang tidak jelas identitasnya</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Kantor Camat Jatinegara Kota Administrasi Jakarta Timur </li>
<li>Kantor Lurah Cipinang Cempedak - Jakarta Timur</li>
<li>Kanwil Kementerian Agama Provinsi DKI Jakarta</li>
<li>Puskesmas Kelurahan Cempedak</li>
<li>Apotik Medi - Z Cawang</li>							
<li>CENTURY</li>
<li>PT. Wijaya Karya (Persero) Tbk.</li>
<li>Aljazeerah Restaurant & Function Hall - Polonia</li>
<li>Bruen coffee & kitchen</li>
<li>Panti Asuhan Parapattan</li>
<li>SMK Dewi Sartika YBW</li>
<li>Kimia Farma Corporate University</li>
...
<li>Kedai Coffe</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi  (021) 8194853</h2>
                            <p class="card-text">Jam operasional 07.00-16.00 WIB</p>
							<ul>
							 
							<li>Instagram: <a href="https://www.instagram.com/kelcipinangcempedak/?hl=id">@kelcipinangcempedak</a> </li>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Link Terkait</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#">E-Kinerja</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">SIPKD</a></li>
