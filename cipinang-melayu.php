...
<head>
  ...
  <title>Kelurahan Cipinang Melayu</title>
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<h1 class="font-weight-light">Kelurahan Cipinang Melayu</h1>
					<p>terletak di Jl. Inspeksi Tarum Barat No. 1 Kalimalang Kelurahan Cipinang Melayu, Kecamatan Makasar, kotamadya Jakarta Timur, propinsi DKI Jakarta 13620 -  Jakarta Timur luas wilayah 2.53 Km2 dengan jumlah RW 13 jumlah RT 132.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Cipinang Melayu <span class="text-muted">Kecamatan Makasar</span></h2>
            <p class="lead">terletak di Jl. Inspeksi Tarum Barat No. 1 Kalimalang Kelurahan Cipinang Melayu, Kecamatan Makasar, kotamadya Jakarta Timur, propinsi DKI Jakarta 13620 -  Jakarta Timur luas wilayah 2.53 Km2 dengan jumlah RW 13 jumlah RT 132.</p>
                    
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Cipinang+Melayu,+Makasar,+East+Jakarta+City,+Jakarta/@-6.249809,106.8829043,14z/data=!3m1!4b1!4m5!3m4!1s0x2e69f325f0ecb017:0xcdfdf8914e9fd28!8m2!3d-6.2528204!4d106.9093" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Kantor Kelurahan Cipinang Melayu</li>
<li>BBWS Ciliwung Cisadane</li>
<li>Puskesmas Kelurahan Cipinang Melayu</li>
<li>Akpindo</li>
<li>UNIVERSITAS Borobudur</li>
<li>SDN Kayu Manis 01 Pagi</li>
<li>Apotek Sahabat Farma</li>
<li>Rumah Sakit Harum Sisma Medika</li>           
<li>Jackal Holidays Luxury Shuttle (Jatiwaringin)</li>
<li>Emado's Shawarma Jatiwaringin</li>
<li>KPAD Jatiwaringin Kalimalangt</li>
<li>Pom Bensin Pertamina</li>
<li>Pizza Hut Restoran</li>
<li>Upnormal Coffee Roasters Jatiwaringin</li>
</p>
                        </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi 021 8580562</h2>
                            <p class="card-text">Jam operasional 07.00-16.00 WIB</p>
							<ul>
							 
							<li>Instagram: <a href="https://www.instagram.com/kelurahan_cipinangmelayu/?hl=id">@kel_cipinangmelayu</a> </li>
