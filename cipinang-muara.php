  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Cipinang Muara</a>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/IMG_9109.JPG" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/IMG_9109.JPG" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/IMG_9109.JPG" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
                    <h4 class="font-weight-light">Kelurahan Cipinang Muara</h4>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Cipinang Muara <span class="text-muted">Kecamatan Makasar</span></h2>
