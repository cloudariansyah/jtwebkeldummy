...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "@",
		//email: "kecamatanciracas@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kecamatan Ciracas</a>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/Kantor Camat Ciracas.JPG" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/Kantor Camat Ciracas 1.JPG" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/.JPG" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<h1 class="font-weight-light">Kecamatan Ciracas</h1>
					<p>terletak di Jl. Penganten Ali No.9 Kelurahan Ciracas, kecamatan Ciracas, Jakarta Timur.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kecamatan Ciracas <span class="text-muted">Kecamatan Ciracas</span></h2>
            <p class="lead">terletak di Jl. Penganten Ali No.9 Kelurahan Ciracas, kecamatan Ciracas, Jakarta Timur. </p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63448.04398869772!2d106.84395525640275!3d-6.328840017820222!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed1a921e2c25%3A0xcf305c4260592445!2sCiracas%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644468766057!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
