  ...
  <main id="main">
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Jati <span class="text-muted">Kecamatan Pulo Gadung</span></h2>
            <p class="lead">terletak di di Jl. Perhubungan Raya No. 79C Kelurahan Jati, Kecamatan Pulo Gadung, kotamadya Jakarta Timur, propinsi DKI Jakarta 13220 -  Jakarta Timur luas wilayah 2.15 km² dengan jumlah RW 8 jumlah RT 128.</p>
                    
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Jati,+Pulo+Gadung,+East+Jakarta+City,+Jakarta/@-6.1944284,106.8888403,15z/data=!3m1!4b1!4m5!3m4!1s0x2e69f4c780749fd3:0xdc69403c46039842!8m2!3d-6.1970255!4d106.8974964" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>KANTOR KELURAHAN JATI JAKARTA TIMUR</li>
<li>Gedung Pertemuan Corpatarin Utama</li>
<li>Puskesmas Kelurahan Jati II</li>
<li>Komplek Taman Berdikari Sentosa</li>
<li>Taman Pemakaman Umum Penggilingan Layur</li>
<li>Kuliner Makanan </li>
<li>SMA Negeri 36 Jakarta Timur</li>
<li>SMP Negeri 92 Jakarta Timur</li>   
<li>Pom Bensin Pertamina</li>
<li>Brewang Coffee</li>
<li>Subway - Rawamangun</li>
</p>
                        </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<li>Instagram: <a href="https://www.instagram.com/kelurahanjati1/?hl=id">@kelurahanjati</a> </li>
							</ul>
                        </div>
                       <!-- <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">More Info</a></div>-->
                    </div>
