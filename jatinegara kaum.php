...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "@kelurahan_jatinegarakaum",
		//email: "keljatinegarakaun@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Jatinegara Kaum</a>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/Foto Kantor Kelurahan Jatinegara Kaum.jpeg" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/Foto Kantor Kelurahan Jatinegara Kaum.jpeg" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/Foto Kantor Kelurahan Jatinegara Kaum.jpeg" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Jatinegara Kaum <span class="text-muted">Kecamatan Jatinegara</span></h2>
            <p class="lead">terletak di Jl.</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31730.090967147957!2d106.85870783408106!3d-6.229232048943442!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f371db68b6af%3A0x23b1331dc3af6398!2sJatinegara%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644465471956!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
