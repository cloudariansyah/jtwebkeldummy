...
<head>
  ...
  <title>Kelurahan Jatinegara Kaum</title>
  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/Foto Kantor Kelurahan Jatinegara Kaum.jpeg" alt="..." /></div>
                <div class="col-lg-5">
			<h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Henrica Kuswandari</h1>
					...
					<p>terletak di Jl. Badarudin No. 1 RT 001/005, Jatinegara Kaum, Kelurahan Jatinegara Kaum, Kecamatan Pulo Gadung, 13250 -  Jakarta Timur luas wilayah XX Ha, dengan jumlah RW XX jumlah RT XX.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31731.861231249426!2d106.88353023406276!3d-6.199877047901843!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f4b0ae518c79%3A0x9bac0a12e5a1ecdc!2sJatinegara%20Kaum%2C%20Pulo%20Gadung%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644468386964!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
...
<li></li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi 021 8191162</h2>
                            <p class="card-text">Jam operasional 07.00-16.00 WIB</p>
							<ul>
								<li>Email: keljatinegarakaun@gmail.com </li>
							<li>Instagram: <a href="https://instagram.com/kelurahan_balimester">@kelurahan_balimester</a> </li>
							<li>Facebook: <a href="https://facebook.com/KelJatinegaraKaum">@Kel Jatinegara Kaum
							</ul>
                        </div>
                       <!-- <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">More Info</a></div>-->
                    </div>
