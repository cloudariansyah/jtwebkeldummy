...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
                whatsapp: "(021) 85914535", // WhatsApp number
          instagram: "@kecjatinegara" ,
		//email: , // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kecamatan Jatinegara</a>
    ...
    <main role="main">
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/kecamatan_jatinegara.jpg" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/kecamatan_jatinegara.jpg" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/kecamatan_jatinegar.jpg" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kecamatan Jatinegara<span class="text-muted">Kecamatan Jatinegara</span></h2>
            <p class="lead">terletak di l. D. I. Panjaitan Kav. 8, RT.11/RW.1, Cipinang Cempedak, Jakarta Timur, RT.11/RW.1, Cipinang Cempedak, Jatinegara, RT.11/RW.1, Cipinang Cempedak, Jatinegara, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13340, Indonesia </p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="https://www.google.com/maps/place/Jatinegara,+East+Jakarta+City,+Jakarta/@-6.229232,106.8587078,14z/data=!3m1!4b1!4m5!3m4!1s0x2e69f371db68b6af:0x23b1331dc3af6398!8m2!3d-6.2284425!4d106.8851503" allowfullscreen="" loading="lazy"></iframe></p></div>
