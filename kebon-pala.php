...
<head>
  ...
  <title>Kelurahan Kebon Pala</title>
  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_kebon_pala.jpg" alt="..." /></div>
                <div class="col-lg-5">
                    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Faisal Rizal, M.Kes</h1>
                    <p><img class="img-fluid rounded mb-4 mb-lg-0" src="{{
                     url('frontend/kelurahan/lurah_kebon_pala.png') }}" alt="foto-lurah" /></p>
              </div>
                  
                    <h4 class="font-weight-light">Kecamatan Makasar</h4>
					<h1 class="font-weight-light">Kelurahan Kebon Pala</h1>
					<p>terletak di  Jl. Cipinang Asem Kelurahan Kebon Pala, Kecamatan Makasar, kotamadya Jakarta Timur, propinsi DKI Jakarta - 13650 -  Jakarta Timur luas wilayah 2.30 Km2 dengan jumlah RW 12 jumlah RT 137.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Kayu+Manis,+Matraman,+East+Jakarta+City,+Jakarta/@-6.201928,106.8535097,15z/data=!3m1!4b1!4m5!3m4!1s0x2e69f46235765b23:0x5009cfd545ac47f9!8m2!3d-6.2026226!4d106.8628267" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Kantor Kelurahan Kebon Pala</li>
<li>SMA Negeri 9 Jakarta</li>
<li>Puskesmas Kelurahan Kebon Pala</li>
<li>Klinik Fajar Medika Pratama</li>
<li>Apotek Generik</li>         
<li>Taman Segitiga Intirub</li>
<li>Komplek TNI AL Usman Harun</li>
<li>Lapangan Dogo</li>
<li>Coffe Shop</li>
<li>SPBT Kemhan Cawang</li>
...
<li>Pizza Hut Restoran</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi 021 8006059</h2>
                            <p class="card-text">Jam operasional 07.00-16.00 WIB</p>
							<ul>
							 
							<li>Instagram: <a href="https://www.instagram.com/p/Cdsa-jKpFtp/?hl=id">@kelurahankebonpala</a> </li>
