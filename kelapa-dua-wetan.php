...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Kelapa Dua Wetan</title>
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Kelapa Dua Wetan</a>
    ...
    <main role="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_kelapa_dua_wetan.jpg" alt="..." /></div>
                <div class="col-lg-5">
		  <h4 class="font-weight-light">Lurah</h4>
                    ...
                    <p><img class="img-fluid rounded mb-4 mb-lg-0" src="{{
                     url('frontend/kelurahan/lurah_kepala-dua_wetan.jpeg') }}" alt="foto-lurah" /></p>
              </div>
                    <h4 class="font-weight-light">Kecamatan Ciracas</h4>
					<h1 class="font-weight-light">Kelurahan Kelapa Dua Wetan</h1>
					<p>terletak di Jl.Klp. Dua Raya No.13, RT.1/RW.8, Klp. Dua Wetan, Kec. Ciracas</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Kelapa Dua Wetan <span class="text-muted">Kecamatan Ciracas</span></h2>
            <p class="lead">terletak di Jl. Klp. Dua Raya No.13, RT.1/RW.8, Klp. Dua Wetan, Kec. Ciracas </p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15861.666843786013!2d106.87341516845879!3d-6.340038550026995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ece22f9c9033%3A0x8999b212140c7de4!2sKelapa%20Dua%20Wetan%2C%20Ciracas%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644468811186!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
