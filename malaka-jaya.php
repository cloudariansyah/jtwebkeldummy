...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Malaka Jaya</title>
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Malaka Jaya</a>
    ...
    <main role="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan Malakah_jaya.jpg" alt="..." /></div>
                <div class="col-lg-5">
			  <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Lidiana Endah</h1>
					...
					<h1 class="font-weight-light">Kelurahan Malaka Jaya</h1>
					<p>terletak di Jl. Raya teratai putih RT.8/RW.6, Malaka Jaya, Kec. Duren Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13460 </p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Malaka Jaya <span class="text-muted">Kecamatan Duren Sawit</span></h2>
            <p class="lead">terletak di Jl.  </p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15865.18335880076!2d106.92636021844072!3d-6.22466854661344!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698cbd44d4ecc7%3A0x1a2245fe3bfd941b!2sMalaka%20Jaya%2C%20Duren%20Sawit%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644467137015!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
