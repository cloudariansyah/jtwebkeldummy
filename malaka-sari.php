...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Malaka Sari </title>
...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "@",
		//email: "kelurahanmalakasari@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Malaka Sari</a>
    ...
    <main role="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
                    <h4 class="font-weight-light">Kelurahan Malaka Sari</h4>
					<h1 class="font-weight-light">Kelurahan Malaka Sari</h1>
					<p>terletak di Jl. </p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Malaka Sari <span class="text-muted">Kelurahan Malaka Sari</span></h2>
