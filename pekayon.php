...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "@",
		//email: "kelurahan.pekayon@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Pekayon</a>
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<p>terletak di Jl. Madrasah RT.003/09, Kelurahan Pekayon, Kecamatan Pasar Rebo </p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            ...
            <p class="lead">terletak di Jl. Madrasah RT.003/09, Kelurahan Pekayon, Kecamatan Pasar Rebo</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
