...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Pondok kelapa</title>
...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "-",
		//email: "Kel.pondokkelapa77@gmail.com", // Email
  ...
  <body>
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Pondok Kelapa</a>
    ...
    <main role="main">
      ...
      <div class="container marketing">
		    ...
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light"> Rasikin</h1>
                    <p><img class="img-fluid rounded mb-4 mb-lg-0" src="{{
                     url('foto/foto-lurah-pondok-kelapa.jpg') }}" alt="foto-lurah" /></p>
              </div>
                    <h4 class="font-weight-light">Kecamatan Duren Sawit</h4>
					<h1 class="font-weight-light">Kelurahan Pondok Kelapa</h1>
					<p>terletak di Jl. H. Dogon Blok G6 No.18, RT.16/RW.2, Pd. Klp., Kec. Duren Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13450 .</p>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
            <h2>Camat Duren Sawit</h2>
            <p>NAMA</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div class="col-lg-4">
            <img class="rounded-circle" src="data:image/gif;base64,R0lGODlhAQABAIAAAHd3dwAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==" alt="Generic placeholder image" width="140" height="140">
            <h2>Lurah Pondok Kelapa</h2>
            <p>Nama</p>
            <p><a class="btn btn-secondary" href="#" role="button">View details &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Pondok Kelapa <span class="text-muted">Kecamatan Duren sawit</span></h2>
            <p class="lead">terletak di Jl. H. Dogon Blok G6 No.18, RT.16/RW.2, Pd. Klp., Kec. Duren Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13450</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15864.968927403315!2d106.93246177695589!3d-6.231764527823622!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698cc21be2d33d%3A0x940be18a3306e28b!2skantor%20Kelurahan%20pondok%20Kelapa!5e0!3m2!1sid!2sid!4v1653971388029!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></iframe></p></div>
