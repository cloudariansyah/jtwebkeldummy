...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
                whatsapp: "021 47881652", // WhatsApp number
          instagram: "@kecamatan.pulogadung" ,
		//email: , // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kecamatan Pulogadung</a>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/kecamatan_pulogadung.jpg" alt="Second slide">
            <div class="container">
