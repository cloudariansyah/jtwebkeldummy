...
<html lang="en">
  <head>
    ...
    <title>Kelurahan Pulogebang</title>
...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "",
		//email: "kel.pulogebang@gmail.com", // Email
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/-01 (5).JPG" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/kelurahan pulogebang (3).JPG" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/kelurahan pulogebang (1).JPG" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<p>terletak di Jl. Rw. Kuning No.3, RT.6/RW.3, Pulo Gebang, Kec. Cakung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13950.</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Pulogebang <span class="text-muted">Kecamatan cakung</span></h2>
            <p class="lead">terletak di Jl. Rw. Kuning No.3, RT.6/RW.3, Pulo Gebang, Kec. Cakung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13950</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.361952459013!2d106.9546326!3d-6.2159062!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698c810ae62803%3A0x9ee43452f88135aa!2sKantor%20Lurah%20Pulo%20Gebang!5e0!3m2!1sid!2sid!4v1653967332828!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p></div>
