  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/kelurahan_rawa_terate.jpg" alt="..." /></div>
                <div class="col-lg-5">
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Rawa Terate<span class="text-muted">Kecamatan Cakung</span></h2>
            <p class="lead">terletak di Jl. Dr. KRT Radjiman Widyodiningrat No.9, RT.12/RW.4, Rw. Terate, Kec. Cakung, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13920 -  Jakarta Timur luas wilayah 4.10 Km2 dengan jumlah RW 6 jumlah RT 59.</p>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/place/Rawa+Terate,+Cakung,+East+Jakarta+City,+Jakarta/@-6.1784865,106.9015654,14z/data=!3m1!4b1!4m5!3m4!1s0x2e698b2eb2df873f:0xbce40cd3e724e6be!8m2!3d-6.1860472!4d106.9211043" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">
							<ul>
							<li>Kantor Kelurahan Rawa Terate</li>
<li>Bizpark Comercial Estate</li>
<li>Puskesmas Kelurahan Rawa Terate</li>
<li>PT. Yamaha Indonesia Motor Manufacturing</li>
<li>PT. Jakarta Central Asia</li>
<li>PTC Pulogadung Trade Center 1</li>
<li>PT. Soho Industri Farmasi</li>
<li>PT Fastrata Buana (Kapal Api)</li>
<li>Terminal Pulo Gadung</li>
<li>Holland Bakery</li>
<li>Jatuh Hati Coffe</li>
...
<li>Pizza Hut Restoran</li>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
                            <h2 class="card-title">Hubungi 021 4602445</h2>
