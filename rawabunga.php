  ...
  <main id="main">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-7"><img class="img-fluid rounded mb-4 mb-lg-0" src="foto/KelurahanRawaBunga.jpeg" alt="..." /></div>
                <div class="col-lg-5">
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Syafei</h1>
                    <p><img class="img-fluid rounded mb-4 mb-lg-0" src="{{
                   url('frontend/kelurahan/foto-lurah-rawabunga') }}" alt="foto-lurah" /></p>
              </div>
                    <h4 class="font-weight-light">Kecamatan Jatinegara</h4>
					<h1 class="font-weight-light">Kelurahan Rawa Bunga</h1>
					<p>terletak di Jl. Jatinegara Timur IV No.1, Kel. Rawa Bunga, Kec. Jatinegara, RT.1/RW.8, Rw. Bunga, Kecamatan Jatinegara, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13350, .</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Rawa Bunga <span class="text-muted">Kecamatan Jatinegara</span></h2>
            <p class="lead">terletak di Jl. Jatinegara Timur IV No.1, Kel. Rawa Bunga, Kec. Jatinegara, RT.1/RW.8, Rw. Bunga, Kecamatan Jatinegara, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13350, .</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7932.647374726613!2d106.86656767205804!3d-6.220979216297703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f37bffd81e95%3A0xa56fb6fdb0772ec9!2sRawa%20Bunga%2C%20Jatinegara%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644467020943!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
