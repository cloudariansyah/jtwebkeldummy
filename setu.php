...
<script type="text/javascript">
    (function () {
		...
		position: "left", // Position may be 'right' or 'left'
          ...
          instagram: "@",
		//email: "kelurahansetu2015@gmail.com", // Email
  ...
  <body>
    ...
    <header>
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="#">Kelurahan Setu</a>
      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel" style="display:none">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="foto/Foto Kantor Kelurahan Setu.JPG" alt="First slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="foto/Foto Kantor Kelurahan Setu.JPG" alt="Second slide">
            <div class="container">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="foto/Foto Kantor Kelurahan Setu.JPG" alt="Third slide">
            <div class="container">
      ...
      <div class="container marketing">
            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                ...
                <div class="col-lg-5">
					...
					<p>terletak di Jl. Setu Raya, Setu, Cipayung</p>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            ...
            <p class="lead">terletak di Jl. Jl. Setu Raya, Setu, Cipayung</p>
                    <a class="btn btn-primary" href="#!">Call Center</a>
          </div>
          <div class="col-md-5">
