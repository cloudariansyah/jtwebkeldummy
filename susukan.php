  ...
  <main id="main">
      ...
      <div class="container marketing">
		    ...
		    <h4 class="font-weight-light">Lurah</h4>
                    <h1 class="font-weight-light">Akmalluddin</h1>
        ...
        <div class="row featurette">
          ...
          <div class="col-md-7">
            <h2 class="featurette-heading">Kelurahan Susukan  <span class="text-muted">Kecamatan Ciracas</span></h2>
            <p class="lead">terletak di Jl. H. Baping RT. 010 RW. 06 Kelurahan Susukan Kecamatan Ciracas – 13750 -  Jakarta Timur luas wilayah 218.85 Ha dengan jumlah RT 89 jumlah RW 7.</p>
                    
          </div>
          <div class="col-md-5">
		  <div class="card-body"><p class="text-white m-0"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15862.335018625312!2d106.86104026845535!3d-6.318278499376447!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ed0b4bf19227%3A0xe64b7baf7ccbcfb7!2sSusukan%2C%20Ciracas%2C%20East%20Jakarta%20City%2C%20Jakarta!5e0!3m2!1sen!2sid!4v1644468883601!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe></p></div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        <div class="card-body">
							...
							<ul>
								<li>Telp: 021 8400134 </li>
								<li>Email: susukankelurahan@gmail.com </li>
							<li>Instagram: <a href="https://instagram.com/kelsusukan_official">@kelsusukan_official</a> </li>
								<li>facebook: <a href="https://facebook.com/Kel.Susukan">@Kel.Susukan</a></li>
							</ul>
                        </div>
                       <!-- <div class="card-footer"><a class="btn btn-primary btn-sm" href="#!">More Info</a></div>-->
                    </div>
